...
public class Bag { // tiles bank of tiles for every game
    // initial quantities of each tile letter letter
    public static final Map<Character,Integer> INIT_QUANTITIES = new HashMap<Character, Integer>(){{
    ...
    // scores for every tile letter letter
    ...
    public Tile drawTile() throws Exception {
        if (isEmpty()) {
